...
function initAudioAnalyser() {
    ...
    audio.src = 'week4/fragment.mp3'; // 学生が書き出したBPM同期音源
    audio.loop = true;
...
function initThreeSwarm() {
    ...
    // 【修正】HTML上のcanvas要素を指定してレンダラーを生成
    ...
    // 粒子の形状（ConeGeometryを球体状のクラスタに配置）
